...
// Browser window mockup 3D (CSS, tanpa iframe) + mini preview portfolio.
export default function DeviceMockup() {
  ...
  // Tilt dasar (-12deg Y, 6deg X) + parallax mouse maksimal ±5deg.
  const rotateY = useTransform(sx, [-1, 1], [-17, -7]);
  const rotateX = useTransform(sy, [-1, 1], [11, 1]);
  ...
  return (
    <div style={{ perspective: "1000px" }} className="relative flex flex-col items-center">
      <motion.div
        animate={{ y: [0, -14, 0] }}
      ...
      >
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 40px 100px -20px rgba(220,38,38,0.3)",
          }}
          className="w-[280px] overflow-hidden rounded-xl border border-accent/15 lg:w-[420px]"
        >
          {/* Browser chrome */}
          <div
            className="flex h-9 items-center gap-2 border-b border-accent/15 px-3"
          ...
          <div className="relative aspect-[16/10] overflow-hidden" style={{ background: "#0a0a0a" }}>
            {/* mini navbar */}
            <div
              className="flex h-5 items-center justify-between px-2"
              style={{ background: "#111" }}
            >
              <span className="font-heading text-[8px] font-bold text-accent">VS</span>
            ...
            <div className="mt-4 flex gap-3 px-4">
              ...
              <div
                className="flex-1 overflow-hidden rounded-md"
                style={{ border: "1px solid rgba(100,100,180,0.2)" }}
              >
